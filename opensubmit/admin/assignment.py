...
from django.forms import ModelForm, ChoiceField, Select, CheckboxSelectMultiple
...
class AssignmentForm(ModelForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['nova_security_groups'] = ChoiceField(widget=CheckboxSelectMultiple, choices=self.get_security_groups(), required=False)
